  ...
  if (!product) {
    return (
      <div className="flex flex-col items-center justify-center py-20 gap-4" style={{ fontFamily: 'Inter, sans-serif' }}>
        ...
        <Link to="/products" className="text-sm text-shopee hover:underline">Kembali</Link>
      </div>
    )
  }
    ...
    <div style={{ fontFamily: 'Inter, sans-serif' }} className="bg-[#f5f5f5] min-h-screen">
      <div className="max-w-[1300px] mx-auto px-5 py-4">
        <button onClick={() => navigate('/products')}
          className="flex items-center gap-1.5 text-sm text-gray-500 hover:text-shopee mb-4 transition group">
        ...
        <div className="flex items-center h-10 text-xs text-gray-500">
          <Link to="/products" className="hover:text-shopee no-underline text-gray-500">Home</Link>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[390px_1fr] gap-[30px]">
                ...
                <div className="flex gap-[10px] mt-3">
                  {photos.map((url, i) => (
                    <button key={i} onClick={() => setCurrentPhoto(i)}
                      className={`w-[70px] h-[70px] shrink-0 overflow-hidden border-2 ${i === currentPhoto ? 'border-shopee' : 'border-gray-200 hover:border-gray-300'}`} style={{ borderRadius: 4 }}>
            ...
            <div>
              ...
              <div className="bg-[#f5f5f5] p-4 flex items-center h-20" style={{ borderRadius: 4 }}>
                <p className="text-[40px] font-bold text-shopee leading-none">
              ...
              <div className="mt-5 space-y-4">
                {product.jenis && (
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-lg bg-shopee-light flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium text-gray-700">{product.jenis}</p>
                    </div>
                  </div>
                )}
        ...
        <div className="flex items-center justify-center gap-3 mt-6 mb-8">
          <button onClick={() => navigate('/products/edit/' + id)}
            className="px-6 py-2.5 bg-shopee text-white text-sm font-medium hover:bg-shopee-dark transition" style={{ borderRadius: 2 }}>
            Edit Produk
          </button>
